...
import CleanStudentDashboard from "./components/dashboard/student/CleanStudentDashboard";
...
const App = () => {
  ...
  const renderDashboardContent = () => {
    // Students now only have the Interactive Exam
  ...
  const renderCurrentPage = () => {
    ...
    if (isAuthenticated && user) {
      ...
      // Default to student dashboard - clean single interface
...
const LandingPage = ({ setCurrentPage }) => (
  ...
  >
    ...
    <Typography variant="h6" mb={5} sx={{ opacity: 0.9, lineHeight: 1.6 }}>
      Your intelligent learning companion powered by AI. Join thousands of
      students on their journey to academic excellence.
    </Typography>
    <Stack
...
const StudentPortal = ({ setCurrentPage }) => {
  ...
  return (
    <GlassCard
      elevation={0}
      sx={{ p: 5, mt: 4, maxWidth: 450, width: "100%", color: "white" }}
    >
      <Typography
        variant="h4"
        fontWeight={800}
  ...
  return (
    ...
    >
      ...
      {error && (
        <Alert
          severity="error"
          sx={{ mb: 3, bgcolor: "rgba(244, 67, 54, 0.1)", color: "white" }}
        >
          {error}
        </Alert>
      )}
